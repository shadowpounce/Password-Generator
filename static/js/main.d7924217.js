/*! For license information please see main.d7924217.js.LICENSE.txt */
!(function () {
  'use strict'
  var e = {
      463: function (e, n, t) {
  ...
  !(function () {
    ...
    var a = 'Output_output__Ol99X',
      o = 'Output_outputCopied__eR+3V',
      u = t(184),
      i = function (e) {
        var n = e.output
            ...
            (0, u.jsx)('div', {
              onClick: function (e) {
                ;(e.target.className = o),
                  e.target.closest('.App').querySelector('textarea').select(),
                  document.execCommand('copy'),
                  setTimeout(function () {
                    return (e.target.className = a)
                  }, 2e3)
              },
              className: a,
              children: n,
      ...
      s = 'Range_range__G5rT8',
      c = 'Range_label__HUE7J',
      f = 'Range_labelValue__GtyKj',
      d = 'Range_labelValueLeft__Rb6CK',
      p = 'Range_sliderRange__EtIdx',
      m = function (e) {
        var n = e.length,
          t = e.setLength
        return (0, u.jsxs)('div', {
          ...
          children: [
            (0, u.jsx)('span', {
              className: ''.concat(f, ' ').concat(d),
              children: '4',
            }),
            (0, u.jsx)('span', { className: f, children: '32' }),
            (0, u.jsxs)('label', {
              className: c,
              htmlFor: 'range',
              children: ['Length: ', n],
    ...
    var y = 'Settings_settings__NMeME',
      b = 'Settings_option__pP5hU',
      k = 'Settings_inputCheckbox__vLLms',
      w = function (e) {
        var n = e.settings,
          t = e.setSettings
        return (0, u.jsxs)('div', {
      ...
      S = 'Button_btn__sxyYH',
      x = function (e) {
        var n = e.generatePassword,
          t = e.settings
        return (0, u.jsx)('button', {
          onClick: function () {
            Object.values(t).find(function (e) {
              return !1 !== e
            }) && n()
          },
          className: S,
    ...
    var _ = function () {
      var n = l(
          (0, e.useState)({ lowerCase: !1, upperCase: !1, numbers: !1 }),
          2
        ),
        t = n[0],
        r = n[1],
        a = l((0, e.useState)('16'), 2),
        o = a[0],
        s = a[1],
        c = l((0, e.useState)('Output'), 2),
        f = c[0],
        d = c[1],
        p = [
          'A',
        ...
        v = function e(n) {
          switch (n) {
            case 0:
              return t.upperCase ? p[E(0, p.length - 1)] : e(E(0, 2))
            case 1:
              return t.lowerCase ? h[E(0, h.length - 1)] : e(E(0, 2))
            case 2:
              return t.numbers ? E(0, 9) : e(E(0, 2))
          }
        }
      return (0, u.jsxs)('div', {
        className: 'App',
        children: [
          (0, u.jsx)('h1', { children: 'Password Generator' }),
          (0, u.jsx)(i, { output: f }),
          (0, u.jsx)(m, { length: o, setLength: s }),
          (0, u.jsx)(w, { settings: t, setSettings: r }),
          (0, u.jsx)(x, {
            settings: t,
            generatePassword: function () {
              for (var e = '', n = 0; n < o; n++) {
                var t = String(v(E(0, 2)))
                e += String(t)
              }
              d(e)
            },
    ...
    n.createRoot(document.getElementById('root')).render((0, u.jsx)(_, {}))
  })()
})()
//# sourceMappingURL=main.d7924217.js.map
